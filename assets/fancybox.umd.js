...
! function(t, e) {
            ...
            function t(e) {
                ...
                o(this, t), this.element = e, this.startPointers = [], this.currentPointers = [], this.startCallback = s, this.moveCallback = l, this.endCallback = h, this.onStart = function(t) {
                    if (!t.button || 0 === t.button) {
                        ...
                        t.preventDefault(), E(), i.currentPointers.push(e), i.startPointers.push(e), (t.target && "setPointerCapture" in t.target ? t.target : i.element).setPointerCapture(t.pointerId), i.element.addEventListener("pointermove", i.onMove), i.element.addEventListener("pointerup", i.onEnd), i.element.addEventListener("pointercancel", i.onEnd)
                    }
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (!this.$container) {
                        ...
                        e.classList.add("fancybox__thumbs"), this.fancybox.$carousel.parentNode.insertBefore(e, this.fancybox.$carousel.nextSibling), this.Carousel = new W(e, S(!0, {
                            Dots: !1,
                            Navigation: !1,
                            Sync: {
                                friction: 0
    ...
    var J = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                var e = this;
                t.Panzoom || (t.Panzoom = new M(t.$el, S(!0, this.fancybox.option("Image.Panzoom", {}), {
                    viewport: t.$wrap,
                    content: t.$image,
                    width: t._width,
                    height: t._height,
    ...
    var ot = {
        ...
        lt = function(t) {
            ...
            return s(i, [{
                ...
                value: function() {
                    var t = this;
                    return this.Carousel = new W(this.$carousel, S(!0, {}, {
                        prefix: "",
                        classNames: {
                ...
                value: function(t) {
                    if (!(i.ignoreFocusChange || ["init", "closing", "customClosing", "destroy"].indexOf(this.state) > -1)) {
                        ...
                        t ? s.indexOf(t.target) > -1 ? this.lastFocus = t.target : this.lastFocus === n ? q(s[s.length - 1]) : q(n) : this.option("autoFocus") && e ? q(e) : s.indexOf(document.activeElement) < 0 && q(n), this.lastFocus = document.activeElement, i.ignoreFocusChange = !1
                    }
                }
            }, {
                key: "hideScrollbar",
                ...
                value: function() {
                    if ("destroy" !== this.state) {
                        ...
                        this.Carousel.destroy(), this.detachPlugins(), this.Carousel = null, this.options = {}, this.events = {}, this.$container.remove(), this.$container = this.$backdrop = this.$carousel = null, t && q(t), st.delete(this.id);
                        var e = i.getInstance();
